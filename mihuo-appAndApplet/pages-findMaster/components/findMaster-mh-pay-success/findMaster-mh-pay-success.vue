<template>
	<view class="content">
		<view class="success_info">
			<image class="pay_icon" src="https://www.51mihuo.com/static/images/order_details/large_ali.png" v-if="paySuccessData.payMethod===4" />
			<image class="pay_icon" src="https://www.51mihuo.com/static/images/order_details/large_wx.png" v-if="paySuccessData.payMethod===3" />
