<template>
	<view>
		<findMaster-mh-sku-popup @input="closeSku" v-model="showPay" title="支付" align="left" height="75%"
			:styleObj="{background:'#f8f8f8'}" @clearCur="clearCur">
			<view class="content-sku">
				...
				<bottom-button title="确认提交" color="#fff" :styleObj="{background:'#424242'}"
					@click="confirm" />
			</view>
		</findMaster-mh-sku-popup>
	</view>
</template>
