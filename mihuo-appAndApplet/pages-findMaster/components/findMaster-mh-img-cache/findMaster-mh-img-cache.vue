...
import { resolveFile, imgcache as storage } from './index'
// #endif
 ...
 * @example <image-cache src="https://example.com/image.png"></findMaster-mh-img-cache>
 */
let queue=[];
export default {
  name: 'ImgCache',
