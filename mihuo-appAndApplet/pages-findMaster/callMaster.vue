<template>
	<view @click="closePopup">
		<view class="call-master" :style="'height:' + windowHeight" @click.stop>
			<!-- 内容 -->
			<view class="call" style="background-color: #fff;">
				...
				<view class="call-main">
					...
					<view class="call-main_content">
						<view class="call-main_content-title">
							...
							<u-icon size="18" class="arrow-down" color="#FFFFFF" name="arrow-down"></u-icon>
						</view>
...
<script>
	...
	export default {
		...
		onLoad(options) {
			...
			this.completeAddress = options.completeAddress
		},
		methods: {
			// 获取工种类型数据字典
			getTypeDirs(){
