<template>
	<view class="u-radio" :style="[radioStyle]">
		...
		<view class="u-radio__label text" @tap="onClickLabel" :style="{
			fontSize: $u.addUnit(labelSize),
			color: `${name == parentData.value ? '#FE6E32' : '#444444'}`,
			border: `${name == parentData.value ? '2rpx solid #FE6E32' : '2rpx solid #F4F4F4'}`,
			backgroundColor: `${name == parentData.value ? '#FFF0EB' : '#F4F4F4'}`
		}">
			<slot />
		</view>
	</view>
