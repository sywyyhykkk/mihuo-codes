			...
			<view class="mescroll-uni-content" :style="{'transform': translateY, 'transition': transition}">
				...
				<view v-if="mescroll.optDown.use" class="mescroll-downwarp" :style="{'background':mescroll.optDown.bgColor,'color':mescroll.optDown.textColor}">
					<view class="downwarp-content">
						<!-- 释放前的动画 <image v-if="isDownLoading" src="https://www.51mihuo.com/static/icon/bee.gif" style="width: 80rpx; height: 80rpx; margin: 0 auto; margin-top: 20rpx;"></image> -->
						<image src="https://www.51mihuo.com/static/icon/loading.gif" style="width: 80rpx; height: 80rpx; margin: 0 auto; margin-top: 20rpx;"></image>
				...
				<view v-if="mescroll.optUp.use && !isDownLoading && upLoadType!==3" class="mescroll-upwarp" :style="{'background':mescroll.optUp.bgColor,'color':mescroll.optUp.textColor}">
					...
					<view v-show="upLoadType===1">
						...
						<view class="upwarp-tip" :style="{color: mescroll.optUp.textColor}">{{ mescroll.optUp.textLoading }}</view>
					</view>
					<!-- 无数据 -->
					<view v-if="upLoadType===2" class="upwarp-nodata" :style="{color: mescroll.optUp.textColor}">{{ mescroll.optUp.textNoMore }}</view>
				</view>
			</view>
