	...
	<view class="search" @click="onClick">
		<view class="content" :style="{'border-radius':radius+'px'}">
			<view class="content-box" :class="{'center':mode === 2}">
				<image class="search-icon" src="https://www.51mihuo.com/static/icon/home_v3/search-26x26.png"></image>
				...
				<text v-if="clearable && isDelShow" class="icon icon-del" @click.stop="clear"></text>
			</view>
			<view v-if="button === 'inside'" class="serachBtn" @click.stop="search">
				搜索
			</view>
		</view>
		<!-- <view v-if="button === 'outside'" class="button" :class="{'active':show||active}" @click.stop="search">
