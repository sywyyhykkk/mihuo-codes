<template>
	<view class="card">
		<!-- #ifdef MP-WEIXIN -->
		<mihuo-image class="img" border-radius="20" :upper-radius="true" :src="$util.thumbnailImage(commodity.coverImg)" mode="widthFix"
			:key="commodity.id"></mihuo-image>
		<!-- #endif -->
		<!-- #ifndef MP -->
		<mihuo-image class="img" border-radius="20" :upper-radius="true" :src="$util.thumbnailImage(commodity.coverImg)"
			:key="commodity.id"></mihuo-image>
		<!-- #endif -->
		<view class="title">
