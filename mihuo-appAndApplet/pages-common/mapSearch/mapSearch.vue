<template>
	<view :style="style">
		<map id='map' style="height: 35%" :scale='map.scale' :show-location='map.showLocation' :longitude='map.longitude'
			...
			<cover-image src="@/pages-common/static/icon/icon_back_black.png" @click="cancel" class="icon-back"></cover-image>
			<cover-image src="@/pages-common/static/images/icon_position.png" class="icon-img"></cover-image>
		</map>
		...
		data() {
			return {
				...
				map: {
					...
					latitude: 0,
					showLocation: true,
					iconPath: '@/pages-common/static/images/icon_position.png',
					height: 30,
					scale: 16,
					controls: [{
						id: 'map',
