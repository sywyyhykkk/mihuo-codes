<template>
  <div>
    ...
    <div class="button__wrap">
      <el-button type="primary" @click="scrollTo(100, 'scrollTop')"
        >垂直滚动100px</el-button
      >
      <el-button type="primary" @click="scrollTo(800, 'scrollTop')"
        >垂直滚动800px</el-button
      >
      <el-button type="primary" @click="scrollTo(100, 'scrollLeft')"
        >水平滚动100px</el-button
      >
      <el-button type="primary" @click="scrollTo(500, 'scrollLeft')"
        >水平滚动500px</el-button
      >
    </div>
