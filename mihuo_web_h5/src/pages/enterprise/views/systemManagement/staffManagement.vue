  ...
  <div>
    <div class="el-card-form">
      <div class="el-card-formLeft">
        <el-button
          v-if="$getPression('company_department_add')"
          icon="plus"
          type="text"
      ...
      <div class="el-card-formRight">
        ...
        >
          ...
          >
            <template #default="scope">
              <el-button
                v-if="$getPression('company_department_auth')"
                size="mini"
                icon="MostlyCloudy"
                type="text"
                style="color: #67c23a"
              ...
              <el-button
                v-if="$getPression('company_department_edit')"
                size="mini"
                icon="edit"
                type="text"
              ...
              <el-button
                v-if="$getPression('company_department_del')"
                size="mini"
                type="text"
                icon="delete"
                class="danger"
