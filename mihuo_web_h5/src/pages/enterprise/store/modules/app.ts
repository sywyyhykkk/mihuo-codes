...
class App extends VuexModule implements AppState {
  ...
  public title = '觅活-塔台' // 标题
  public logoTitle = wsCache.get('companys') ? wsCache.get('companys')[0].companyName : ''// logo标题
  public userInfo = 'userInfo' // 登录信息存储字段-建议每个项目换一个字段，避免与其他项目冲突，路由
  public userInfoDetail = 'userInfoDetail' //用户的具体信息
  public greyMode = false // 是否开始灰色模式，用于特殊悼念日
  public showBackTop = true // 是否显示回到顶部
  public showMenuTab = false // 是否固定一级菜单
  public cityOperator = 'cityOperator' // 当前登录运营商信息
  public powerInfo = 'enterprisePression' // 所有的按钮权限
