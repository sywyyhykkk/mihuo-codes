<template>
  <div :class="classObj" class="app__wrap">
    ...
    <logo v-if="showLogo && layout === 'Classic'"  style="width: 200%;z-index: 1" :collapsed="collapsed" />
    <div
      id="sidebar__wrap"
      class="sidebar__wrap"
      :class="{
      ...
      >
        ...
        >
          <div v-if="showNavbar" class="navbar__wrap">
            ...
            <div
              v-if="showScreenfull || showUserInfo"
              class="navbar__wrap--right"
            >
              <user-info
                v-if="showUserInfo"
                class="hover-container user-container"
              />
              <screenfull
                v-if="showScreenfull"
                class="hover-container screenfull-container"
              />
            </div>
          </div>
