      ...
      >
        ...
        >
          <template #default="scope">
            <el-image
              preview-teleported
              :src="scope.row.companyLogoSl"
              :preview-src-list="[scope.row.companyLogoYl]"
            />
          </template>
        </el-table-column>
        <el-table-column prop="companyName" label="企业名称" />
        <el-table-column prop="contactTel" label="联系电话" align="center" />
        ...
        >
          <template #default="scope">
            <el-image
              preview-teleported
              lazy
              :src="scope.row.legalIdcardBackSl"
              :preview-src-list="[scope.row.legalIdcardBackYl]"
            />
          </template>
        </el-table-column>
        <el-table-column
        ...
        >
          <template #default="scope">
            <el-image
              preview-teleported
              lazy
              :src="scope.row.legalIdcardFrontSl"
              :preview-src-list="[scope.row.legalIdcardFrontYl]"
            />
          </template>
        </el-table-column>
    ...
    const getData = async () => {
      ...
      if (res) {
        ...
        state.tableData.map((item) => {
          item['companyLogoSl'] = thumbnailImage(item['companyLogo'], true, '')
          item['companyLogoYl'] = thumbnailImage(item['companyLogo'], false, '')
          item['companyLogoInfo'] = thumbnailImage(
            item['companyLogo'],
            false,
            'info'
          )
          item['legalIdcardBackSl'] = thumbnailImage(
            item['legalIdcardBack'],
            true,
            ''
          )
          item['legalIdcardBackYl'] = thumbnailImage(
            item['legalIdcardBack'],
            false,
            ''
          )
          item['legalIdcardBackInfo'] = thumbnailImage(
            item['legalIdcardBack'],
            false,
            'info'
          )
          item['legalIdcardFrontSl'] = thumbnailImage(
            item['legalIdcardFront'],
            true,
            ''
          )
          item['legalIdcardFrontYl'] = thumbnailImage(
            item['legalIdcardFront'],
            false,
            ''
          )
          item['legalIdcardFrontInfo'] = thumbnailImage(
            item['legalIdcardFront'],
            false,
            'info'
          )
