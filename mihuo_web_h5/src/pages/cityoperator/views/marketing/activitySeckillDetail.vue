<template>
    <div class="container">
        <el-card shadow="never" class="el-card">
            <div class="card-left">
                ...
                <ul class="group-info">
                    ...
                    <li>参与秒杀人数：<i>{{ statistics.groupNum || 0}}</i>人</li>
                </ul>
            </div>
        ...
        <el-table
            ...
            <el-table-column label="参与秒杀人数" align="center" prop="currentGroupCount"/>
            <el-table-column label="秒杀库存" align="center" prop="flashPromotionStock"/>
            <el-table-column label="秒杀价格" align="center" prop="flashPromotionPrice"/>
        </el-table>
    </div>
</template>
