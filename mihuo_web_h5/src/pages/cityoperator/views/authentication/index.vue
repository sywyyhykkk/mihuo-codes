<template>
  <div>
    <el-card>
      <el-input v-model="formTop.username" placeholder="姓名" />
      <el-input v-model="formTop.idcard" placeholder="身份证号" />
        ...
        >
          <template #default="scope">
            <el-image
              ...
              :src="getThumbnailImage(scope.row.idcardFront, true)"
              :preview-src-list="[
                getThumbnailImage(scope.row.idcardFront, false)
              ]"
            />
          </template>
        </el-table-column>
        ...
        >
          <template #default="scope">
            <el-image
              preview-teleported
              style="max-height: 60px"
              :src="getThumbnailImage(scope.row.idcardBack, true)"
              :preview-src-list="[
                getThumbnailImage(scope.row.idcardBack, false)
              ]"
            />
          </template>
        </el-table-column>
