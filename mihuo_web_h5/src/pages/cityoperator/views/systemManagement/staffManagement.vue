  ...
  <div>
    <div class="el-card-form">
              ...
              <el-dropdown>
                ...
                <template #dropdown>
                  <el-dropdown-menu>
                    ...
                    <el-dropdown-item @click.stop="nodeEdit"
                      >编辑部门
                    </el-dropdown-item>
                    <el-dropdown-item @click.stop="handleDelete"
                      >删除部门
                    </el-dropdown-item>
                  </el-dropdown-menu>
                </template>
      ...
      <div class="el-card-formRight">
        <el-card>
          ...
          <div class="el-card-right">
            <el-button type="primary" icon="plus" @click="addForm()"
              >添加
            </el-button>
          </div>
        </el-card>
      ...
      >
        ...
        <template #footer>
          <span class="dialog-footer">
            <el-button type="primary" @click="handleNodeConfirm"
              >确 定</el-button
            >
