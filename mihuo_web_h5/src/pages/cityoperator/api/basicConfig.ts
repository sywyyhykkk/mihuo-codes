...
export const updateTemplateDetails = (data:any) => {
  return fetch({ url: `/basic/surveytemplate/updateTemplateDetails`, method: 'post',data})
}
...
export const bizCustomerForfeitPage = (params:any) => {
  return fetch({ url: `/order/bizcustomerforfeit/page`, method: 'get',params})
}
...
export const bizCustomerForfeitRemoveById = (data:any) => {
  return fetch({ url: `/order/bizcustomerforfeit/removeById/${data.id}`, method: 'get'})
}
...
export const bizCustomerForfeitSave = (data:any) => {
  return fetch({ url: `/order/bizcustomerforfeit/save`, method: 'post',data})
}
...
export const bizCustomerForfeitUpdateById = (data:any) => {
  return fetch({ url: `/order/bizcustomerforfeit/updateById`, method: 'post',data})
}
