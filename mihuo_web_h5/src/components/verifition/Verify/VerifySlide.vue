  ...
  <div style="position: relative">
    ...
    >
      ...
      >
        ...
        >
          <el-icon :color="iconColor" :size="20" style="vertical-align: middle">
            <ArrowRightBold v-if="iconClass == 'icon-right'" />
            <Select v-if="iconClass == 'icon-check'" />
            <CloseBold v-if="iconClass == 'icon-close'" />
          </el-icon>
          <div
            v-if="type === '2'"
