...
__webpack_require__.d(messages_namespaceObject, {
  ...
  "NotifyMessage": function() { return NotifyMessage; }
});
...
(function (MessageTypeEnum) {
    ...
    /** 通知消息 */
    MessageTypeEnum[MessageTypeEnum["Notify"] = 2] = "Notify";
            ...
            return common_generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fetch(url, { method: "GET", mode: "cors", headers: _headers, credentials: "include" })];
                    case 1:
                        response = _a.sent();
            ...
            return common_generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        headers === null || headers === void 0 ? void 0 : headers.forEach(function (val, key, map) { _headers.append(key, val); });
                        return [4 /*yield*/, fetch(url, { method: "POST", mode: "cors", headers: _headers, credentials: "include", body: JSON.stringify(body) })];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, response];
                }
...
var MessageBase = /** @class */ (function () {
    function MessageBase(messageType, referenceId, sourceId, createTime, changeTime, type, content, fileId, customContent) {
    ...
    MessageBase.fromMap = function (map) {
        ...
        if (messageType == MessageTypeEnum.Notify) {
            return NotifyMessage.fromMap(map);
        }
        else {
...
var NormalMessage = /** @class */ (function (_super) {
    ...
    function NormalMessage(id, targetId, status, referenceId, sourceId, createTime, changeTime, type, content, fileId, customContent) {
        var _this = _super.call(this, MessageTypeEnum.Normal, referenceId !== null && referenceId !== void 0 ? referenceId : 0, sourceId !== null && sourceId !== void 0 ? sourceId : 0, createTime !== null && createTime !== void 0 ? createTime : 0, changeTime !== null && changeTime !== void 0 ? changeTime : 0, type !== null && type !== void 0 ? type : ContentType.Text, content !== null && content !== void 0 ? content : '', fileId !== null && fileId !== void 0 ? fileId : 0, customContent !== null && customContent !== void 0 ? customContent : '') || this;
    ...
    NormalMessage.fromMap = function (map) {
        ...
        return new NormalMessage((_a = map['id']) !== null && _a !== void 0 ? _a : map['Id'], (_b = map['targetId']) !== null && _b !== void 0 ? _b : map['TargetId'], (_c = map['status']) !== null && _c !== void 0 ? _c : map['Status'], (_d = map['referenceId']) !== null && _d !== void 0 ? _d : map['ReferenceId'], (_e = map['sourceId']) !== null && _e !== void 0 ? _e : map['SourceId'], (_f = map['createTime']) !== null && _f !== void 0 ? _f : map['CreateTime'], (_g = map['thangeTime']) !== null && _g !== void 0 ? _g : map['ChangeTime'], (_h = map['cype']) !== null && _h !== void 0 ? _h : map['Type'], (_j = map['fontent']) !== null && _j !== void 0 ? _j : map['Content'], (_k = map['fileId']) !== null && _k !== void 0 ? _k : map['FileId'], (_l = map['customContent']) !== null && _l !== void 0 ? _l : map['CustomContent']);
    };
...
var GroupMessage = /** @class */ (function (_super) {
    ...
    function GroupMessage(id, groupId, atUsers, sharpUsers, referenceId, sourceId, createTime, changeTime, type, content, fileId, customContent) {
    ...
    GroupMessage.fromMap = function (map) {
        ...
        return new GroupMessage((_a = map['id']) !== null && _a !== void 0 ? _a : map['Id'], (_b = map['groupId']) !== null && _b !== void 0 ? _b : map['GroupId'], (_c = map['atUsers']) !== null && _c !== void 0 ? _c : map['AtUsers'], (_d = map['sharpUsers']) !== null && _d !== void 0 ? _d : map['SharpUsers'], (_e = map['referenceId']) !== null && _e !== void 0 ? _e : map['ReferenceId'], (_f = map['sourceId']) !== null && _f !== void 0 ? _f : map['SourceId'], (_g = map['createTime']) !== null && _g !== void 0 ? _g : map['CreateTime'], (_h = map['changeTime']) !== null && _h !== void 0 ? _h : map['ChangeTime'], (_j = map['type']) !== null && _j !== void 0 ? _j : map['Type'], (_k = map['content']) !== null && _k !== void 0 ? _k : map['Content'], (_l = map['fileId']) !== null && _l !== void 0 ? _l : map['FileId'], (_m = map['customContent']) !== null && _m !== void 0 ? _m : map['CustomContent']);
    };
    return GroupMessage;
}(MessageBase));
 ...
 * 通知消息仅能在群组中发送
 */
var NotifyMessage = /** @class */ (function (_super) {
    messages_extends(NotifyMessage, _super);
    function NotifyMessage(id, groupId, isConfirm, referenceId, sourceId, createTime, changeTime, type, content, fileId, customContent) {
        var _this = _super.call(this, MessageTypeEnum.Notify, referenceId !== null && referenceId !== void 0 ? referenceId : 0, sourceId !== null && sourceId !== void 0 ? sourceId : 0, createTime !== null && createTime !== void 0 ? createTime : 0, changeTime !== null && changeTime !== void 0 ? changeTime : 0, type !== null && type !== void 0 ? type : ContentType.Text, content !== null && content !== void 0 ? content : '', fileId !== null && fileId !== void 0 ? fileId : 0, customContent !== null && customContent !== void 0 ? customContent : '') || this;
        _this.Id = id !== null && id !== void 0 ? id : 0;
        _this.GroupId = groupId !== null && groupId !== void 0 ? groupId : 0;
        _this.IsConfirm = isConfirm !== null && isConfirm !== void 0 ? isConfirm : false;
        return _this;
    }
    NotifyMessage.fromMap = function (map) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l;
        if (typeof map == 'string') {
            map = JSON.parse(map);
        }
        return new NotifyMessage((_a = map['id']) !== null && _a !== void 0 ? _a : map['Id'], (_b = map['groupId']) !== null && _b !== void 0 ? _b : map['GroupId'], (_c = map['isConfirm']) !== null && _c !== void 0 ? _c : map['IsConfirm'], (_d = map['referenceId']) !== null && _d !== void 0 ? _d : map['ReferenceId'], (_e = map['sourceId']) !== null && _e !== void 0 ? _e : map['SourceId'], (_f = map['createTime']) !== null && _f !== void 0 ? _f : map['CreateTime'], (_g = map['changeTime']) !== null && _g !== void 0 ? _g : map['ChangeTime'], (_h = map['type']) !== null && _h !== void 0 ? _h : map['Type'], (_j = map['content']) !== null && _j !== void 0 ? _j : map['Content'], (_k = map['fileId']) !== null && _k !== void 0 ? _k : map['FileId'], (_l = map['customContent']) !== null && _l !== void 0 ? _l : map['CustomContent']);
    };
    ...
    IMRequest.prototype.onWsData = function (data) {
        if (typeof data == "string") {
            ...
            if (buffer.length > 0) {
                ...
                else if (map["MessageType"] == MessageTypeEnum.Notify) {
                    this.callBack.onReceiveNotifyMessage.call(this, NotifyMessage.fromMap(map));
                }
                else {
...
var MessageCallBack = /** @class */ (function () {
    function MessageCallBack() {
         ...
         * @returns
         */
        this.onReceiveNotifyMessage = function (notify) { return console.log("onReceiveNotifyMessage: notify:" + notify); };
        /**
         * close 回调
