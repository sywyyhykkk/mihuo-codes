...
export const checkedkeys = ['/components-demo', '/components-demo/echarts', '/components-demo/preview',
  ...
  '/table-demo/total-table', '/table-demo/merge-table', '/table-demo/custom-admin', '/directives-demo',
  '/directives-demo/clipboard', '/hooks-demo', '/hooks-demo/watermark', '/hooks-demo/useScrollTo', '/icon/admin',
