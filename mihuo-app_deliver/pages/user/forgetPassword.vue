	...
	<view>
		...
		<view v-show="pageIndex===0">
			<view class="forget_password" style="margin-top: 16rpx;">
				<image src="../../static/images/user/forgetPassword1.png" class="forget_password_image"></image>
			...
			<!-- <view class="forget_password" style="border-radius:0 0 16rpx 16rpx;">
				<image src="../../static/images/user/forgetPassword2.png" class="forget_password_image"></image>
		...
		<view v-show="pageIndex===3">
			<view class="mihuo_protocol">
				<image class="protocol_logo" src="../../static/images/user/logo.png"></image>
				...
				<view class="agree_information">
					<label class="agree_information_text">
						<radio value="r1" color="$themeColor" class="agree_information_radio" /> 您同意服务提供者及觅活使用并传送相关数据用于身份验证。
					</label>
	...
	export default {
		...
		methods: {
			...
			getCode() {
				...
				this.$httpApi.getMSGCode(this.mobile, 'SMSMSG', true, {}).then(res => {
					if (res) {
