<template>
	<view>
		...
		<z-nav-bar>
			<view slot="default" class="nav-title">催办</view>
		...
		<view class="p_top">
			<form>
				...
				<view class="bg_fff">
					<view class="select align-items">
						<text class="label">期望天数</text>
						<view class="select_con">
							<input placeholder="请输入期望天数" placeholder-style="color:#999999;font-size:28rpx"
							 style="width: 230rpx;" type="digit" />
						</view>
					</view>
				</view>
				<view class="bg_fff">
				...
				<view class="bg_fff">
					...
					<view class="textarea_box">
						<view class="textarea">
							<textarea placeholder-style="color:#909199" placeholder="请输入申请原因"
...
<script>
	export default{
		...
		methods:{
			...
			seeRecord(){
				uni.navigateTo({
					url: "/pages/construction/apply/applyRecord"
				})
			}
		}
	}
