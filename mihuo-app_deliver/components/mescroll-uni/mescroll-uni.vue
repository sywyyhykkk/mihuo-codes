<template>
	<view class="mescroll-uni-warp">
		<scroll-view :id="viewId" class="mescroll-uni" :class="{'mescroll-uni-fixed':isFixed}"
			...
			@touchcancel="touchendEvent" :scroll-y='scrollable' :enable-back-to-top="true">
			<!-- 状态栏 -->
			...
			<view class="mescroll-uni-content" :style="{'transform': translateY, 'transition': transition}">
				...
				<view v-if="mescroll.optDown.use" class="mescroll-downwarp"
					...
					<view class="downwarp-content">
						<!-- 释放前的动画 <image v-if="isDownLoading" src="../../static/icon/bee.gif" style="width: 80rpx; height: 80rpx; margin: 0 auto; margin-top: 20rpx;"></image> -->
						<image src="../../static/icon/bee.gif"
							style="width: 80rpx; height: 80rpx; margin: 0 auto; margin-top: 20rpx;"></image>
...
<script>
	...
	export default {
		...
		props: {
			...
			height: [String,
			Number], // 指定mescroll的高度, 此项有值,则不使用fixed. (支持20, "20rpx", "20px", "20%"格式的值, 其中纯数字则默认单位rpx, 百分比则相对于windowHeight)
