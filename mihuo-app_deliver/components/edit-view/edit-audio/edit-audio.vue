	...
	<view style="background-color: #FFFFFF;">
		<view v-if="jsondata.listdata && jsondata.listdata.length > 0">
			<view v-for="item in jsondata.listdata" :key="item.name" class="audioContent" @click="playVoice(item)">
				<image v-if="voicePlayingId==item.name" class="playIcon" src="@/static/images/play-audio.png" />
				<image v-if="voicePlayingId==item.name" class="playIcon" src="@/static/images/audio-play-rich.gif">
