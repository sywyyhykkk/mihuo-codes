<template>
	<view>
		<view v-if="loading" class="skeleton" :class="{ animate: animate }" :style="{ justifyContent: flexType,marginTop:titleMarginTop+'rpx',display:openFlex?'flex':'block'}">
			<!-- 轮播图 -->
			<view v-if="imgTitle" class="skeleton-imgTitle" :style="{height:imgTitleHeight+'rpx'}"></view>
			<!-- 头像图 -->
