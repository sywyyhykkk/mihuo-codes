...
let otherShareList = [
	{
		icon: "/uni_modules/mihuoPPshare/static/icon_copy.png",
		text: "复制",
		provider: "copy",
		onClick: onCopy
	},
	{
		icon: "/uni_modules/mihuoPPshare/static/icon_more.png",
		text: "更多",
		provider: "more",
		onClick: onMore
	}
...
uni.getProvider({
	...
	success: function (res) {
		if (res.provider.includes('sinaweibo')) {
			platformShareList = [{
				icon: "/uni_modules/mihuoPPshare/static/icon_weibo.png", 
				text: "新浪微博",
				onClick: onShare,
				provider: "sinaweibo",
				type: 0
		...
		if (res.provider.includes('qq')) {
			platformShareList = [{
				icon: "/uni_modules/mihuoPPshare/static/icon_qq.png",
				text: "QQ",
				onClick: onShare,
				provider: "qq",
				type: 1
		...
		if (res.provider.includes('weixin')) {
			platformShareList = [{
				icon: "/uni_modules/mihuoPPshare/static/icon_weixin.png",
				text: "微信好友",
				onClick: onShare,
				provider: "weixin",
			...
			{
				icon: "/uni_modules/mihuoPPshare/static/icon_pengyouquan.png",
				text: "朋友圈",
				onClick: onShare,
				provider: "weixin",
			...
			{
				icon: "/uni_modules/mihuoPPshare/static/ic_xiaochengxu.png",
				text: "小程序",
				onClick: onShare,
				provider: "weixin",
				scene: "WXSceneSession",
