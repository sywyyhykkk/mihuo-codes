! function(e, r) {
	"object" == typeof exports && "undefined" != typeof module ? module.exports = r() : "function" == typeof define &&
		define.amd ? define(r) : (e || self).createPersistedState = r()
}(this, function() {
	var e = function(e) {
			return function(e) {
	...
	function u(r, i, a) {
		(a = a || {}).arrayMerge = a.arrayMerge || n, a.isMergeableObject = a.isMergeableObject || e, a
		...
		return f === Array.isArray(r) ? f ? a.arrayMerge(r, i, a) : function(e, r, n) {
			...
			return n.isMergeableObject(e) && o(e).forEach(function(r) {
				...
				(function(e, r) {
					return c(e, r) && !(Object.hasOwnProperty.call(e, r) && Object
						.propertyIsEnumerable.call(e, r))
				})(e, o) || (i[o] = c(e, o) && n.isMergeableObject(r[o]) ? function(e, r) {
	...
	return function(e) {
		...
		function u(e, r) {
			return Array.isArray(r) ? r.reduce(function(r, t) {
				return function(e, r, t, n) {
					return !/^(__proto__|constructor|prototype)$/.test(r) && ((r = r.split ? r
						.split(".") : r.slice(0)).slice(0, -1).reduce(function(e, r) {
						return e[r] = e[r] || {}
					}, e)[r.pop()] = t), e
				}(r, t, (n = e, void 0 === (n = ((o = t).split ? o.split(".") : o).reduce(function(
					e, r) {
					return e && e[r]
				}, n)) ? void 0 : n));
				var n, o
		...
		return e.fetchBeforeUse && (f = s()),
			function(n) {
				e.fetchBeforeUse || (f = s()), "object" == typeof f && null !== f && (n.replaceState(e
					.overwrite ? f : i(n.state, f, {
