			...
			<scroll-view scroll-x class="u-scroll-view" :scroll-left="scrollLeft" scroll-with-animation>
				<view class="u-scroll-box" :class="{'u-tabs-scorll-flex': !isScroll}">
					<view class="u-tab-item u-line-1" :id="'u-tab-item-' + index" v-for="(item, index) in list"
						...
						<view class="item-count" v-if="item[name] == '服务订单'">
							<text class="item-text">保障</text>
						</view>
						{{ item[name] || item['name']}}
					</view>
			...
			getTabRect() {
				...
				query.exec(
					function(res) {
						...
						// 		uni.setStorageSync('tabQueryInfo', res)
						// 	}
						// 	this.tabQueryInfo = uni.getStorageSync('tabQueryInfo')
						// } else {
