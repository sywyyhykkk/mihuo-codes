<template>
	<view class="u-dropdown">
		...
		<!-- 用contentHeight会导致菜单栏不出现时也会遮住下方的列表,导致无法滚动 -->
...
<script>
	...
	export default {
		...
		methods: {
			...
			updateContentHeight() {
				this.contentHeight = this.backupsContentHeight
			},
			// 获取下拉菜单内容的高度
			getContentHeight() {
				...
				this.$uGetRect('.u-dropdown__menu').then(res => {
					...
					// this.contentHeight = 'max-content';
					if (this.isMaskHeight) {
						this.contentHeight = 'max-content';
					} else {
						this.contentHeight = (windowHeight - res.bottom) + 'px';
						this.backupsContentHeight = this.contentHeight
					}
				})
			}
		}
