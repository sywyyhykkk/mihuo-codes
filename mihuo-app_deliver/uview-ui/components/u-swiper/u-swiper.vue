<template>
	<view class="u-swiper-wrap" :style="{
		...
		<swiper duration='100' acceleration :current="elCurrent" @change="change" @animationfinish="animationfinish" :interval="interval" :circular="circular" :duration="duration" :autoplay="autoplay"
		 ...
		 :style="{
			...
			<swiper-item class="u-swiper-item" v-for="(item, index) in list" :key="index">
				<view class="u-list-image-wrap" @tap.stop.prevent="listClick(index)" :class="[uCurrent != index ? 'u-list-scale' : '']" :style="{
					...
					<image v-if="item.type == 'video'" src="/static/images/video-start.png" class="video-play-img" mode=""></image>
...
<style lang="scss" scoped>
	...
	.u-indicator-item-round-active {
		width: 34rpx;
		background: linear-gradient(0deg, #108CFE -0.01%, #0F93FE 8.9%, #0CA8FD 39.56%, #0BB4FD 70.06%, #0AB8FD 100%);
	}
