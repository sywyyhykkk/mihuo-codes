<template>
	<view class="u-select">
		...
		<u-popup :maskCloseAble="maskCloseAble" mode="bottom" :height="selectAreaHeight" :mask="false" :popup="false" v-model="value" length="auto" :safeAreaInsetBottom="safeAreaInsetBottom" @close="close" :z-index="uZIndex">
			<view class="u-select">
